...
```javascript
import isPropertyKey from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-property-key@v0.2.2-esm/index.mjs';
```
...
[@stdlib/assert/is-nonnegative-integer]: https://github.com/stdlib-js/assert-is-nonnegative-integer/tree/esm
